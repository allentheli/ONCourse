...
const CHANGELOG = [
  { date:'2026-09-19', text:'0.20.0: A plan that cannot fit one page without small type now prints on two pages at full size instead of shrinking further. Body text never drops below 82% of normal and map labels never below 9 px. The builder says before you print when a plan will take two pages; shortening the care-team note or the step text brings it back to one.' },
