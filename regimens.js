...
const CHANGELOG = [
  { date:'2026-09-19', text:'0.19.1: Print fix. A plan edited well beyond the library defaults (long notes, extra steps) could spill onto a second page because the fit stopped at its readability floors. It now keeps shrinking past them when that is the only way to stay on one page, as it did before 0.19.0.' },
